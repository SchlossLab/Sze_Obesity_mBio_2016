...
the studies (Figures 6, S4-S9). Although there is no biological
...
(Figure S4). In fact, the maximum power among any of the studies to
...
subject populations and methods. Considering the median AUC for models
trained and tested on the same data with ten-fold cross validation only
varied between 0.51 and 0.65 and there was not a strong signal in the
alpha diversity data, we suspect that there is insufficient signal to
reliably classify individuals.
...
neighbor algorithm using a 3\% distance threshold (26, 31). All sequence
processing was performed using mothur (v.1.37.0) (32).
...
(B:F), Shannon diversity, observed richness, and Shannon evenness (33).
...
(34). Next, we compared the community structure from non-obese and obese
individuals using analysis of molecular variance (AMOVA) with
Bray-Curtis distance matrices (35). This analysis was performed using
...
used the AUCRF (1.1) R package to generate Random Forest models (36).
...
pROC (1.8) R package (37). Finally, we performed power and sample number
...
\textbf{Figure 1: PRISMA flow diagram of total records searched (38).}
...
\textbf{Figure S4: Power (A) and sample size simulations (B) for B:F for
...
\textbf{Figure S9: Power (A) and sample size simulations (B) for
...
31. \textbf{Edgar RC}, \textbf{Haas BJ}, \textbf{Clemente JC},
...
33. \textbf{Magurran AE}. 2003. Measuring biological diversity 264.

\hyperdef{}{ref-lme4ux5f2015}{\label{ref-lme4ux5f2015}}
34. \textbf{Bates D}, \textbf{Mächler M}, \textbf{Bolker B},
...
35. \textbf{Anderson MJ}. 2001. A new method for non-parametric
...
36. \textbf{Calle ML}, \textbf{Urrea V}, \textbf{Boulesteix A-L},
...
37. \textbf{Robin X}, \textbf{Turck N}, \textbf{Hainard A},
...
38. \textbf{Moher D}, \textbf{Liberati A}, \textbf{Tetzlaff J},
