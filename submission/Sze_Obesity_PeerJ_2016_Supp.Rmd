...
```{r Table_S2, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r Table_S3, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r Figure_S8, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE,  fig.path="results/figures/", dev = c("pdf", "png")}
...
```{r Figure_S9, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE,  fig.path="results/figures/", dev = c("pdf", "png")}
...
```{r Figure_S10, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE,  fig.path="results/figures/", dev = c("pdf", "png")}
