...
Study <- c("Baxter", "HMP", "Ross", "Escobar", "Arumugam", "Turnbaugh", "Zupancic", "Wu")
Year <- c("2015", "2011", "2015", "2014", "2010", "2009", "2012", "2012")
Total <- c("n=172", "n=256", "n=63", "n=30", "n=85", "n=146", "n=207", "n=58")
tpos <- c(25, 16, 20, 6, 20, 52, 47, 2) #obese in low diversity group
tneg <- c(61, 112, 12, 9, 23, 21, 57, 27) #nonobese in low diversity group
cpos <- c(22, 10, 18, 4, 17, 47, 31, 3) #obese in high diversity group
cneg <- c(64, 118, 13, 11, 25, 26, 72, 26) #nonobese in high diversity group
RR <- c(1.14, 1.6, 1.08, 1.50, 1.15, 1.11, 1.50, 0.67)
low <- c(0.70, 0.75, 0.72, 0.53, 0.71, 0.88, 1.04, 0.12)
high <- c(1.85, 3.39, 1.61, 4.26, 1.87, 1.38, 2.16, 3.70)
...
m = 8
T = -2*log(0.608)-2*log(0.214)-2*log(0.236)-2*log(0.439)-2*log(0.575)-2*log(0.376)-2*log(0.025)-2*log(0.64)
T.pval = 1-pchisq(T,m) #P-value = 0.01

##Alternatively can use built in package (I trust this more)
anova.rma(res)
# QM = 5.1101, p-value = 0.0238
...
Year <- c("2015", "2011", "2015", "2014", "2010", "2009", "2012", "2012")
Total <- c("n=172", "n=256", "n=63", "n=30", "n=85", "n=146", "n=207", "n=58")
tpos <- c(24, 13, 16, 3, 17, 45, 37, 2) #obese in low BF group
tneg <- c(62, 115, 16, 12, 26, 28, 67, 27) #nonobese in low BF group
cpos <- c(23, 13, 22, 7, 20, 54, 41, 3) #obese in high BF group
cneg <- c(63, 115, 9, 8, 22, 19, 62, 26) #nonobese in high BF group
RR <- c(1.04, 1.00, 0.70, 0.43, 0.83, 0.83, 0.89, 0.67)
low <- c(0.64, 0.48, 0.47, 0.14, 0.51, 0.66, 0.66, 0.12)
high <- c(1.70, 2.07, 1.07, 1.35, 1.35, 1.05, 1.27, 3.70)
...
##Calculate combined P-value
m = 8
T = -2*log(0.864)-2*log(1.00)-2*log(0.089)-2*log(0.121)-2*log(0.452)-2*log(0.111)-2*log(0.53)-2*log(0.64)
T.pval = 1-pchisq(T,m) #P-value = 0.03155827

##Alternatively can use built in package (I trust this more)
anova.rma(res)
  # QM = 5.3494, p-value = 0.0207
...
t.test(H.Zscore ~ obese, data=group.data.test2) #P-value = 0.002583
table(group.data.test2$obese) # No = 695 | Yes = 340
...
###################################Firmicutes#######################################
#Look at Obese versus non-obese
t.test(Zfirm ~ obese, data=group.data.test2) #P-value = 0.8149
table(group.data.test2$obese)
  # No = 695 | Yes = 340
...
#Look at Obese versus non-obese
t.test(zbf ~ obese, data=group.data.test2) #P-value = 0.4379
table(group.data.test2$obese)
  # No = 695 | Yes = 340
