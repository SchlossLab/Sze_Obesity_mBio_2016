...
/share/scratch/schloss/mothur/mothur "#merge.files(input=1.fasta-2.fasta-3.fasta-4.fasta-5.fasta-6.fasta-7.fasta-8.fasta-9.fasta-10.fasta-11.fasta-12.fasta-13.fasta-14.fasta-15.fasta-16.fasta-17.fasta-18.fasta-19.fasta-20.fasta-21.fasta, output=group16.fasta)"
/share/scratch/schloss/mothur/mothur "#merge.files(input=1.groups-2.groups-3.groups-4.groups-5.groups-6.groups-7.groups-8.groups-9.groups-10.groups-11.groups-12.groups-13.groups-14.groups-15.groups-16.groups-17.groups-18.groups-19.groups-20.groups-21.groups, output=group16.groups)"
