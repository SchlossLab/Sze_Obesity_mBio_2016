---
title: "A Meta Analysis of the Bacterial Microbiome and Human Obesity"
output:
  html_document:
    keep_md: yes
  word_document:
...
Study <- c("Baxter", "Ross", "Goodrich", "Escobar", "Zupancic", "Yatsunenko", "HMP", "Nam", "Wu", "Arumugam", "Turnbaugh")

Year <- c(2016, 2015, 2014, 2014, 2012, 2012, 2011, 2011, 2011, 2010, 2009)

Total <- c(172, 63, 525, 30, 227, 531, 256, 18, 65, 85, 154)

Processed <- c(172, 63, 507, 30, 207, "In Progress", 256, 18, 58, 85, 146)

table1 <- cbind(Study, Year, Total, Processed)

colnames(table1) <- c("Study", "Year", "Total n", "n After Sequence Processing")
