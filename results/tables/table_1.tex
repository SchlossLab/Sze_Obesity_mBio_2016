...
\begin{tabular}{lccccccccc}
  \hline
\textbf{Study (Ref.)} & \textbf{\bigcell{c}{Subjects \\ (N)}} & \textbf{\bigcell{c}{Obese \\ (\%)}} & \textbf{\bigcell{c}{Average BMI \\ (Min-Max)}} & \textbf{\bigcell{c}{Female \\ (\%)}} & \textbf{\bigcell{c}{Average Age \\ (Min-Max)}} & \textbf{\bigcell{c}{Non-Hispanic \\ White (\%)}} & \textbf{\bigcell{c}{Sequencing \\ Method}} & \textbf{\bigcell{c}{16S rRNA \\ Gene Region}} & \textbf{\bigcell{c}{AMOVA \\ (P-value)}} \\ 
  \hline
