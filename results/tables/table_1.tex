...
\textbf{Table 1. Summary of obesity, demographic, and beta-diversity
analysis data for the studies used in the meta-analysis.} NA indicates
that those metadata were not available for that study.
...
\begin{tabular}{lccccccc}
  \hline
\textbf{Study} & \textbf{\bigcell{c}{Subjects \\ (N)}} & \textbf{\bigcell{c}{Obese \\ (\%)}} & \textbf{\bigcell{c}{Average BMI \\ (Min-Max)}} & \textbf{\bigcell{c}{Female \\ (\%)}} & \textbf{\bigcell{c}{Average Age \\ (Min-Max)}} & \textbf{\bigcell{c}{Non-Hispanic \\ White (\%)}} & \textbf{\bigcell{c}{AMOVA \\ (P-value)}} \\ 
  \hline
