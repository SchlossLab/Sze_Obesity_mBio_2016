...
**Table 1. Summary of obesity, demographic, and beta-diversity analysis data for the studies used in the meta-analysis.** NA indicates that those metadata were not available for that study.
...
colnames(study_summary) <- c("Study", "\\bigcell{c}{Subjects \\\\ (N)}",
													"\\bigcell{c}{Obese \\\\ (\\%)}",
